"""
Django settings for swagger-demo project.
...
ROOT_URLCONF = 'swagger-demo.urls'
...
WSGI_APPLICATION = 'swagger-demo.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER':
    'apps.core.exceptions.core_exception_handler',
...
SWAGGER_SETTINGS = {
    ...
    'DEFAULT_INFO': 'swagger-demo.urls.swagger_info',
...
LOGGING = {
    ...
    'handlers': {
        ...
        'info': {
            ...
            'filename': os.path.join(BASE_LOG_DIR, "swagger-demo.info.log"),
        ...
        'error': {
            'level': 'ERROR',
            'class': 'logging.handlers.TimedRotatingFileHandler',
            'filename': os.path.join(BASE_LOG_DIR, "swagger-demo.error.log"),
            # 'maxBytes': 1024 * 1024 * 50,
            'backupCount': 10,
            'formatter': 'standard',
            'encoding': 'utf-8',
